...
class RandomAccessIterator {
 public:
  ...
  RandomAccessIterator &operator=(
      const RandomAccessIterator<T, IteratorTraits> &rhs) {
    if (this == &rhs) {
      return *this;
    }
    ptr_ = rhs.ptr_;
  ...
  friend RandomAccessIterator &operator+(const int num,
  ...
  RandomAccessIterator<T, IteratorTraits> operator+(
      const RandomAccessIterator<T, IteratorTraits> &rhs) {
  ...
  bool operator==(
      const RandomAccessIterator<T, IteratorTraits> &rhs) const noexcept {
    return ptr_ == rhs.ptr_;
  }
